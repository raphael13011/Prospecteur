...
async function init() {
  ...
  await db.batch([
    ...
    `CREATE INDEX IF NOT EXISTS idx_credits_lookup ON credits(user_id, date)`,
    ...
    `CREATE TABLE IF NOT EXISTS leads (
      ...
      size TEXT, contact_name TEXT, contact_role TEXT,
  ...
  console.log("✅ Tables créées : users, credits, searches, leads, password_resets");
  console.log("✅ Base de données Turso prête !");
}
